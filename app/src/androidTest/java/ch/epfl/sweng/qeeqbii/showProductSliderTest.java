...
import ch.epfl.sweng.qeeqbii.activities.ShowProductActivity;
...
public class showProductSliderTest {

    @Rule
    public final ActivityTestRule<ShowProductActivity> mActivityRule =
            new ActivityTestRule<>(ShowProductActivity.class);
    ...
    public void testBackToMain() {
        ...
        ShowProductActivity myActivity = mActivityRule.getActivity();
