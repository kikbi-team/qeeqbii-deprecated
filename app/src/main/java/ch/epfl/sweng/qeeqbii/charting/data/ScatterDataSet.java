...
public class ScatterDataSet extends LineScatterCandleRadarDataSet<com.github.mikephil.charting.data.Entry> implements IScatterDataSet {
    ...
    public ScatterDataSet(List<com.github.mikephil.charting.data.Entry> yVals, String label) {
        super(yVals, label);
    }
    ...
    public com.github.mikephil.charting.data.DataSet<com.github.mikephil.charting.data.Entry> copy() {
        ...
        List<com.github.mikephil.charting.data.Entry> yVals = new ArrayList<Entry>();
