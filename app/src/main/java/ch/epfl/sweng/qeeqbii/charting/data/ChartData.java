...
public abstract class ChartData<T extends IDataSet<? extends com.github.mikephil.charting.data.Entry>> {
     ...
     * @param axis
     */
    protected void calcMinMax(com.github.mikephil.charting.data.Entry e, AxisDependency axis) {
    ...
    public boolean removeEntry(float xValue, int dataSetIndex) {
        ...
        com.github.mikephil.charting.data.Entry e = dataSet.getEntryForXValue(xValue, Float.NaN);
