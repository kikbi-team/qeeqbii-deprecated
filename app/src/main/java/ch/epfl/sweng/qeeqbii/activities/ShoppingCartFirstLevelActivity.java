...
public class ShoppingCartFirstLevelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = (RecyclerView)findViewById(R.id.recycler_item_shopping_list);
        ...
        RecyclerViewAdapter adapter = new RecyclerViewAdapter(this, m_cart);
    ...
    public void openSecondLevelShoppingCart(View view)
    {
