...
public class BarDataSet extends BarLineScatterCandleBubbleDataSet<com.github.mikephil.charting.data.BarEntry> implements IBarDataSet {
    ...
    public BarDataSet(List<com.github.mikephil.charting.data.BarEntry> yVals, String label) {
        super(yVals, label);
    ...
    public com.github.mikephil.charting.data.DataSet<com.github.mikephil.charting.data.BarEntry> copy() {
        ...
        List<com.github.mikephil.charting.data.BarEntry> yVals = new ArrayList<com.github.mikephil.charting.data.BarEntry>();
        yVals.clear();
     ...
     */
    private void calcEntryCountIncludingStacks(List<com.github.mikephil.charting.data.BarEntry> yVals) {
     ...
     * DataSet
     */
    private void calcStackSize(List<com.github.mikephil.charting.data.BarEntry> yVals) {
