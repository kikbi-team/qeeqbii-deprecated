...
public class CandleDataSet extends LineScatterCandleRadarDataSet<com.github.mikephil.charting.data.CandleEntry> implements ICandleDataSet {
    ...
    public CandleDataSet(List<com.github.mikephil.charting.data.CandleEntry> yVals, String label) {
        super(yVals, label);
    }
    ...
    public com.github.mikephil.charting.data.DataSet<com.github.mikephil.charting.data.CandleEntry> copy() {
        ...
        List<com.github.mikephil.charting.data.CandleEntry> yVals = new ArrayList<com.github.mikephil.charting.data.CandleEntry>();
        yVals.clear();
    ...
    @Override
    protected void calcMinMax(com.github.mikephil.charting.data.CandleEntry e) {
