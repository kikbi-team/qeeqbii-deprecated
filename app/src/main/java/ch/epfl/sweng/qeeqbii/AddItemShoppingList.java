...
import ch.epfl.sweng.qeeqbii.bean.ItemShoppingList;
import ch.epfl.sweng.qeeqbii.bean.ShoppingList;
import ch.epfl.sweng.qeeqbii.dao.ItemShoppingListDAO;
import ch.epfl.sweng.qeeqbii.dao.ShoppingListDAO;
import ch.epfl.sweng.qeeqbii.vansadapt.ItemShoppingListCursorAdapter;
import ch.epfl.sweng.qeeqbii.vansexception.VansException;
import ch.epfl.sweng.qeeqbii.vansformat.CustomFloatFormat;
import ch.epfl.sweng.qeeqbii.vansintent.CustomIntentOutside;
import ch.epfl.sweng.qeeqbii.vansprefs.UserPreferences;
import ch.epfl.sweng.qeeqbii.vanswatch.CustomEditTextWatcher;
