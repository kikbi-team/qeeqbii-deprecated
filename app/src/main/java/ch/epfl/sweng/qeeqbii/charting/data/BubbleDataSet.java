...
public class BubbleDataSet extends BarLineScatterCandleBubbleDataSet<com.github.mikephil.charting.data.BubbleEntry> implements IBubbleDataSet {
    ...
    public BubbleDataSet(List<com.github.mikephil.charting.data.BubbleEntry> yVals, String label) {
        super(yVals, label);
    }
    ...
    @Override
    protected void calcMinMax(com.github.mikephil.charting.data.BubbleEntry e) {
        super.calcMinMax(e);
    ...
    public com.github.mikephil.charting.data.DataSet<com.github.mikephil.charting.data.BubbleEntry> copy() {
        ...
        List<com.github.mikephil.charting.data.BubbleEntry> yVals = new ArrayList<BubbleEntry>();
