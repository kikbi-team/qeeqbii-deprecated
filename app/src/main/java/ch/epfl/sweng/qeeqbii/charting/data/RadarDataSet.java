...
public class RadarDataSet extends LineRadarDataSet<com.github.mikephil.charting.data.RadarEntry> implements IRadarDataSet {
    ...
    public RadarDataSet(List<com.github.mikephil.charting.data.RadarEntry> yVals, String label) {
        super(yVals, label);
    }
    ...
    public com.github.mikephil.charting.data.DataSet<com.github.mikephil.charting.data.RadarEntry> copy() {
        ...
        List<com.github.mikephil.charting.data.RadarEntry> yVals = new ArrayList<RadarEntry>();
