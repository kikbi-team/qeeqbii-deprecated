package ch.epfl.sweng.qeeqbii.charting.renderer;
...
public class CombinedChartRenderer extends com.github.mikephil.charting.renderer.DataRenderer {
     ...
     */
    protected List<com.github.mikephil.charting.renderer.DataRenderer> mRenderers = new ArrayList<com.github.mikephil.charting.renderer.DataRenderer>(5);
            ...
            switch (order) {
                case BAR:
                    if (chart.getBarData() != null)
                        mRenderers.add(new com.github.mikephil.charting.renderer.BarChartRenderer(chart, mAnimator, mViewPortHandler));
                    break;
                case BUBBLE:
                    if (chart.getBubbleData() != null)
                        mRenderers.add(new com.github.mikephil.charting.renderer.BubbleChartRenderer(chart, mAnimator, mViewPortHandler));
                    break;
                case LINE:
                    if (chart.getLineData() != null)
                        mRenderers.add(new com.github.mikephil.charting.renderer.LineChartRenderer(chart, mAnimator, mViewPortHandler));
                    break;
                case CANDLE:
                ...
                case SCATTER:
                    if (chart.getScatterData() != null)
                        mRenderers.add(new com.github.mikephil.charting.renderer.ScatterChartRenderer(chart, mAnimator, mViewPortHandler));
                    break;
            }
        }
    }
