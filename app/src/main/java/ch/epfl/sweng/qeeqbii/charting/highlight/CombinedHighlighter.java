 ...
 */
public class CombinedHighlighter extends com.github.mikephil.charting.highlight.ChartHighlighter<CombinedDataProvider> implements IHighlighter
{
    ...
    protected List<com.github.mikephil.charting.highlight.Highlight> getHighlightsAtXValue(float xVal, float x, float y) {
        ...
        for (int i = 0; i < dataObjects.size(); i++) {
            ...
            if (barHighlighter != null && dataObject instanceof BarData) {
                com.github.mikephil.charting.highlight.Highlight high = barHighlighter.getHighlight(x, y);
                ...
                for (int j = 0, dataSetCount = dataObject.getDataSetCount(); j < dataSetCount; j++) {
                    ...
                    List<com.github.mikephil.charting.highlight.Highlight> highs = buildHighlights(dataSet, j, xVal, DataSet.Rounding.CLOSEST);
