...
public class Transformer {
     ...
     * @return
     */
    public com.github.mikephil.charting.utils.MPPointD getValuesByTouchPoint(float x, float y) {

        com.github.mikephil.charting.utils.MPPointD result = com.github.mikephil.charting.utils.MPPointD.getInstance(0, 0);
        getValuesByTouchPoint(x, y, result);
        return result;
    }

    public void getValuesByTouchPoint(float x, float y, com.github.mikephil.charting.utils.MPPointD outputPoint) {
     ...
     * @return
     */
    public com.github.mikephil.charting.utils.MPPointD getPixelForValues(float x, float y) {
        ...
        return com.github.mikephil.charting.utils.MPPointD.getInstance(xPx, yPx);
    }
